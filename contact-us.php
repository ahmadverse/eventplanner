            ...
            <div class="col-lg-12">
              <div class="card  border-primary mb-5">
                <div class="col-lg-12 text-center mt-2" id="heading2 ">
                  <h1><p class="animate__animated animate__fadeInUp" >Admin Support</p></h1>
                  <p class="animate__animated animate__fadeInUp" class="lead">(Ask Admin) </p>
                </div>
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="card  border-dark">
                        <div class="card-body">
                          ...
                          <?php $i=0; while ($row = mysqli_fetch_array( $result)): ?>
                              ...
                              <?php $to=$row['email']; ?>
                          <?=(++$i)?> &nbsp;
                          <b>Email : </b>  <?=$row['email']?> ( <?=$row['name']?> ) <br>
                          <b>Question :  <?=$row['message']?></b> <br><br>
